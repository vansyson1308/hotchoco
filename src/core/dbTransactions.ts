/**
 * Database transaction operations — now backed by Google Sheets adapter.
 *
 * Legacy SQL builders are retained as deprecated exports for backward compatibility.
 * New code should use GoogleSheetsAdapter directly.
 */
...
/**
 * @deprecated Use GoogleSheetsAdapter.recordSale() instead.
 * Retained for n8n workflow compatibility during migration.
 */
...
/**
 * @deprecated Use GoogleSheetsAdapter directly.
 */

/** @deprecated Use GoogleSheetsAdapter.getConsignorItems() instead. */
...
/** @deprecated Use GoogleSheetsAdapter.getConsignorSales() instead. */
...
/** @deprecated Use GoogleSheetsAdapter.getSettlementsByConsignor() instead. */
